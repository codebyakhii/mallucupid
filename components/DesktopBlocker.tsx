      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 py-32 text-center text-white">
          ...
          <div className="mt-10 flex items-center justify-center gap-4">
            <a href="#download" className="flex items-center gap-3 bg-black text-white px-6 py-3.5 rounded-xl hover:bg-gray-900 transition-colors">
            ...
            <a href="#download" className="flex items-center gap-3 bg-black text-white px-6 py-3.5 rounded-xl hover:bg-gray-900 transition-colors">
              ...
              <div className="text-left">
                <p className="text-[10px] font-medium opacity-70">GET IT ON</p>
      ...
      <section id="download" className="py-24 bg-gradient-to-br from-[#FF4458] via-[#FF6B54] to-[#FF7854] text-white text-center">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="flex items-center justify-center gap-4">
            <a href="#" className="flex items-center gap-3 bg-black text-white px-6 py-3.5 rounded-xl hover:bg-gray-900 transition-colors">
              <svg className="w-7 h-7" viewBox="0 0 24 24" fill="currentColor"><path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/></svg>
              <div className="text-left">
                <p className="text-[10px] font-medium opacity-70">Download on the</p>
                <p className="text-sm font-bold -mt-0.5">App Store</p>
      ...
      <footer className="bg-white border-t border-gray-100 py-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <a href="#" className="flex items-center gap-2.5 bg-black text-white px-4 py-2.5 rounded-lg text-xs font-bold hover:bg-gray-900 transition-colors">
